...
fn main() {
    ...
    // Load shaders
    let vertex_shader_src = include_str!("shaders/rotate_in_time.vs");
    let fragment_shader_src = include_str!("shaders/rotate_in_time.fs");
    ...
    loop {
        ...
        let rotation_angle = cgmath::deg(elapsed_as_f32() * 50.0);
