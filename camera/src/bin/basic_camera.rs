...
fn main() {
    ...
    // Load shaders
    let vertex_shader_src = include_str!("shaders/basic_camera.vs");
    let fragment_shader_src = include_str!("shaders/basic_camera.fs");
    ...
    loop {
        ...
        let view = cgmath::Matrix4::look_at(cgmath::Point3::new(0.0f32, 0.0, 3.0),
